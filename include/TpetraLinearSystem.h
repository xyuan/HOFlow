...
public:
    ...
    void sumInto(unsigned numEntities,
    ...
    void sumInto(const std::vector<stk::mesh::Entity> & entities,
    ...
    void applyDirichletBCs(stk::mesh::FieldBase * solutionField,
...
private:
    ...
    // Copies a stk::mesh::field to a tpetra multivector. 
    // Each dof/node is written into a different
