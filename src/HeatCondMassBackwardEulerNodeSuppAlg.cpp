...
HeatCondMassBackwardEulerNodeSuppAlg::HeatCondMassBackwardEulerNodeSuppAlg(Realm &realm) : 
...
void HeatCondMassBackwardEulerNodeSuppAlg::setup() {
    dt_ = realm_.timeIntegrator_->get_time_step();
}

void HeatCondMassBackwardEulerNodeSuppAlg::node_execute(double *lhs, double *rhs, stk::mesh::Entity node) {
