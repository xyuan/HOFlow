...
HeatCondMassBDF2NodeSuppAlg::HeatCondMassBDF2NodeSuppAlg(Realm &realm) : 
...
void HeatCondMassBDF2NodeSuppAlg::setup() {
...
void HeatCondMassBDF2NodeSuppAlg::node_execute(double *lhs, double *rhs, stk::mesh::Entity node) {
