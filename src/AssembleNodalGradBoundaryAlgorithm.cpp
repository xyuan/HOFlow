...
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
AssembleNodalGradBoundaryAlgorithm::AssembleNodalGradBoundaryAlgorithm(Realm &realm,
                                                                       stk::mesh::Part *part,
...
//-------- execute ---------------------------------------------------------
//--------------------------------------------------------------------------
void AssembleNodalGradBoundaryAlgorithm::execute() {
    ...
    // Iterate through all face buckets with boundary faces
    ...
    for ( stk::mesh::BucketVector::const_iterator ib = face_buckets.begin(); ib != face_buckets.end(); ++ib ) {
        ...
        for ( stk::mesh::Bucket::size_type k = 0 ; k < length ; ++k ) {
            ...
            for ( int ip = 0; ip < numScsIp; ++ip ) {
                ...
                // suplemental; volume of full control volume of nodeNN
